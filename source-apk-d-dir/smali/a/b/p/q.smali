...
.method public final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    instance-of v0, p1, La/f/f/i/b;

    if-eqz v0, :cond_0

    move-object v0, p1

    check-cast v0, La/f/f/i/c;

    .line 4
    iget-object v1, v0, La/f/f/i/c;->g:Landroid/graphics/drawable/Drawable;

    if-eqz v1, :cond_8

    .line 5
    invoke-virtual {p0, v1, p2}, La/b/p/q;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-virtual {v0, p2}, La/f/f/i/c;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, La/b/p/q;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p1, v2}, La/b/p/y0;->c(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v7, v0}, La/b/p/q;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {p1, v0}, La/b/p/y0;->c(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2, v2}, La/b/p/q;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
